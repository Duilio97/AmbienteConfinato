...
public class ActivityLogin extends AppCompatActivity {
    ...
    //public static ArrayList<String> stepaPassed = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        authStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Intent I = new Intent(ActivityLogin.this, UserActivity2.class);
                    startActivity(I);
                } else {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent I = new Intent(ActivityLogin.this, RegCode.class);
                startActivity(I);
            }
        });
                    ...
                    firebaseAuth.signInWithEmailAndPassword(userEmail, userPaswd).addOnCompleteListener(ActivityLogin.this, new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if (!task.isSuccessful()) {
                                ...
                                startActivity(new Intent(ActivityLogin.this, UserActivity2.class));
